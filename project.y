...
%token int_const char_const float_const id string type_const qual_const
%token IF FOR DO WHILE BREAK CONTINUE RETURN PUNC or_const and_const eq_const shift_const rel_const inc_const
%token ELSE HEADER
%left '+' '-'
%left '*' '/'
%nonassoc "then"
